...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/04/15 16:17:23 by grusso            #+#    #+#             */
/*   Updated: 2021/04/15 18:10:22 by grusso           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	texture_put(t_game *game, t_sprites *sprite)
{
	...
	i_sprite = sprite->text_y * game->sp_texture->size_line + sprite->text_x
		* game->sp_texture->bpp / 8;
	game->image->img_data[index] = game->sp_texture->img_data[i_sprite];
	game->image->img_data[index + 1] = game->sp_texture->img_data[i_sprite + 1];
	game->image->img_data[index + 2] = game->sp_texture->img_data[i_sprite + 2];
}
